...
public class AdminLogin extends AppCompatActivity {
                    ...
                    mAuth.signInWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()) {
                                ...
                                startActivity(new Intent(AdminLogin.this,patientList.class));
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(AdminLogin.this, user.getEmail() + user.getDisplayName(), Toast.LENGTH_SHORT).show();
                            updateUI(user);
                            progressDialog.setMessage("Please Wait While Login...");
                            progressDialog.setTitle("Login");
                            progressDialog.setCanceledOnTouchOutside(false);
    ...
    private void updateUI(FirebaseUser user) {
        Intent intent=new Intent(AdminLogin.this,patientList.class);
